defmodule ApplauseButtonElixirServerWeb.Router do
  use ApplauseButtonElixirServerWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ApplauseButtonElixirServerWeb.Layouts, :root}
  ...
  if Application.compile_env(:applause_button_elixir_server, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ApplauseButtonElixirServerWeb.Telemetry
